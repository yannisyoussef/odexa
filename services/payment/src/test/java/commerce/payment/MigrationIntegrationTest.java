...
class MigrationIntegrationTest {
    ...
    void freshMigrationAndRestartValidateWithoutReapplying() {
        ...
        jdbc.update("INSERT INTO payment (id,tenant_id,order_id,customer_id,amount_minor,currency,payment_method,status,reservation_event_id,correlation_id,attempts) VALUES ('11111111-1111-4111-8111-111111111111','aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa','22222222-2222-4222-8222-222222222222','legacy-owner',5000,'USD','pm_approved','REVIEW_REQUIRED','33333333-3333-4333-8333-333333333333','44444444-4444-4444-8444-444444444444',5)");
        assertEquals("REVIEW_REQUIRED:5", jdbc.queryForObject("SELECT status || ':' || attempts FROM payment", String.class));
    }
